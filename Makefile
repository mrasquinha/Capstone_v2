...
PRE_UNINSTALL = :
POST_UNINSTALL = :
bin_PROGRAMS = simMc2Mesh_debug$(EXEEXT)
subdir = .
...
libIris_debug_a-packetSource.o: source/tests/packetSource.cc
	...
	mv -f $(DEPDIR)/libIris_debug_a-packetSource.Tpo $(DEPDIR)/libIris_debug_a-packetSource.Po
#	source='source/tests/packetSource.cc' object='libIris_debug_a-packetSource.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libIris_debug_a_CXXFLAGS) $(CXXFLAGS) -c -o libIris_debug_a-packetSource.o `test -f 'source/tests/packetSource.cc' || echo '$(srcdir)/'`source/tests/packetSource.cc

libIris_debug_a-packetSource.obj: source/tests/packetSource.cc
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libIris_debug_a_CXXFLAGS) $(CXXFLAGS) -MT libIris_debug_a-packetSource.obj -MD -MP -MF $(DEPDIR)/libIris_debug_a-packetSource.Tpo -c -o libIris_debug_a-packetSource.obj `if test -f 'source/tests/packetSource.cc'; then $(CYGPATH_W) 'source/tests/packetSource.cc'; else $(CYGPATH_W) '$(srcdir)/source/tests/packetSource.cc'; fi`
	mv -f $(DEPDIR)/libIris_debug_a-packetSource.Tpo $(DEPDIR)/libIris_debug_a-packetSource.Po
#	source='source/tests/packetSource.cc' object='libIris_debug_a-packetSource.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libIris_debug_a_CXXFLAGS) $(CXXFLAGS) -c -o libIris_debug_a-packetSource.obj `if test -f 'source/tests/packetSource.cc'; then $(CYGPATH_W) 'source/tests/packetSource.cc'; else $(CYGPATH_W) '$(srcdir)/source/tests/packetSource.cc'; fi`
