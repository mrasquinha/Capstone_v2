...
////////	3) Tag bits t should be less than k+l+r
...
#define NO_OF_ROWS 4096 		//4096 //  (int)log2() = r bits. 
#define NO_OF_COLUMNS 256         	//  (int)log2() = c bits. 
#define COLUMN_SIZE 16        		//  (int)log2() = v bits.  Column Size = 2bytes
#define BLOCKS_PER_ROW 64          	//  (int)log2() = n bits.  Cache line Per Row
...
#define THREAD_BITS_POSITION 12
//#define CORE_UNCORE_RATIO 3
#define MAX_BUFFER_SIZE 8	
#define MAX_CMD_BUFFER_SIZE 4
#define RESPONSE_BUFFER_SIZE (NO_OF_CHANNELS * (NO_OF_BANKS*NO_OF_RANKS + MAX_CMD_BUFFER_SIZE)) / 2  // Size = Upper Limit / 2		
...
#define NETWORK_THREADID_BITS 5
...
#define t_CAS 	6 * ceil (1.0 * MEM_CYCLE)	// 6-6-6 So 6 Mem Cycles
...
#define t_CCD 	ceil (DDR_BUS_WIDTH/2 * BUS_CYCLE)// TODO Bus Cycle = Half Mem Cycle. burst of 8 beats
...
//  Total is 4 GB
//  Bandwidth is 4.3 GB/s
//  4-4-4 means 4*2 DDR half cycles for t_CAS and (4 / 533M/2) = 15ns for t_RCD, t_RP
...
#define DDR_BUS_WIDTH 8		// 64 bit = 8 bytes
#define BUS_SPEED 266		
#define CORE_SPEED 3000		// 3G = 3000 cycles in 1us
#define MEM_SPEED 533		//  artifact of not knowing correct timing values
...
#define t_CAS 	4 * ceil (1.0 * MEM_CYCLE)	// 4-4-4 So 4 Mem Cycles
#define t_RTRS 	ceil (1.0 * MEM_CYCLE)
#define t_OST 	ceil (1.0 * MEM_CYCLE)
...
//  4-4-4 means 4*2 DDR half cycles for t_CAS and (4 / 667M/2) = 12ns for t_RCD, t_RP

/*
#define DDR_BUS_WIDTH 4		// 32 bit = 4 bytes
#define BUS_SPEED 333		
#define CORE_SPEED 3000		// 3G = 3000 cycles in 1us
#define MEM_SPEED 667		//  artifact of not knowing correct timing values
#define MEM_CYCLE (CORE_SPEED*1.0 / MEM_SPEED)	// artifact of not knowing correct timing values
#define BUS_CYCLE (CORE_SPEED*1.0 / BUS_SPEED)
...
#define t_CCD 	ceil (DDR_BUS_WIDTH/2 * BUS_CYCLE)// TODO Bus Cycle = Half Mem Cycle. burst of 4 beats
#define t_AL 	0				// No posted CAS will have t_AL = 0
#define t_CWD 	t_CAS-t_CMD
