 ...
 * =====================================================================================
 *
 *       Filename:  genericAddressDecoder.h
 *
 *    Description:  
 *
 *        Version:  1.0
 ...
 * =====================================================================================
 */
#ifndef  _genericaddressdecoder_h_INC
#define  _genericaddressdecoder_h_INC
...
class GenericAddressDecoder
{
    public:
        ...
        void set_no_virtual_channels ( unsigned int ch );
...
}; /* -----  end of class GenericAddressDecoder  ----- */

#endif   /* ----- #ifndef _genericaddressdecoder_h_INC  ----- */
