 ...
 * =====================================================================================
 */
#ifndef  _GenericArbiter_h_INC
#define  _GenericArbiter_h_INC
 ...
 * =====================================================================================
 */
class GenericArbiter: public Arbiter
{
    public:
        uint node_ip;
        uint address;
        GenericArbiter ();                             /* constructor */
        ~GenericArbiter (); 
...
}; /* -----  end of class GenericArbiter  ----- */

#endif   /* ----- #ifndef _GenericArbiter_h_INC  ----- */
